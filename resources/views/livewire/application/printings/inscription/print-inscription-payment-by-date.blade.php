<x-pinting-layout>
    ...
    <div>
        <div style="border: 1px solid black;padding: 6px">
            ...
            <span style="margin-top: 8px;margin-bottom: 8px ">Inscription du: {{(new DateTime($date))->format('d/m/Y')}}</span>
        </div>
    </div>
        <table sty>
        ...
        <div style="text-align: right;font-size: 18px;margin-top: 10px;">
            <span style="font-weight: bold">Total: </span><span>{{ number_format($total,1,',',' ') }} {{$currency}}</span>
