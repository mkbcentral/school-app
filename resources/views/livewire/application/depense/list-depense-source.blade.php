                                            ...
                                            @foreach ($listDepenseSource as $index => $depenseSource)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <x-button wire:click.prevent='edit({{ $depenseSource }},{{ $depenseSource->id }})'
                                                        ...
                                                        <x-button wire:click.prevent='delete({{ $depenseSource->id }})'
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <x-input class="" type='text' placeholder="Source"
