        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <x-input class="" type='text' placeholder="Tél" wire:model.defer='phone' />
                    @error('phone')
                        <span class="error text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <x-input class="" type='text' placeholder="Autre tél" wire:model.defer='other_phone' />
                    @error('other_phone')
                        <span class="error text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <x-input class="" type='text' placeholder="Nom de la section" wire:model.defer='email' />
                    @error('email')
                        <span class="error text-danger">{{ $message }}</span>
                    @enderror
                </div>
