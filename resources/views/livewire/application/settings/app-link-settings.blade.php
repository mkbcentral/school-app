                      ...
                      @else
                          ...
                          <table class="table table-stripped">
                              ...
                              @foreach ($listUser as $user)
                                  <tr wire:click.prevent="getUser({{$user}})" class="{{$user?->id==$userData?->id?'bg-info':''}}">
                  ...
                  @if($userData !=null)
                       ...
                       <div class="card">
                                           ...
                                           <div class="form-group clearfix">
                                               <div  class="icheck-primary d-inline">
                                                   <input type="checkbox" id="{{str_replace(' ', '',$appLink->name)}}"
                                                          wire:model.defer="linksMainSelected" value="{{$appLink->id}}">
                           ...
                           <div class="card-footer d-flex justify-content-end">
                               <x-button wire:click.prevent="affecteMainLinks" type="button" class="btn btn-primary"><i class="fas fa-sync"></i> Attribuer</x-button>
                           </div>
                       </div>
                       <div class="card">
                           <div class="card-header">
                                           ...
                                           <div class="form-group clearfix">
                                               <div  class="icheck-primary d-inline">
                                                   <input type="checkbox" id="{{$link->id}}"
                                                          wire:model.defer="linksSubSelected" value="{{$link->id}}" {{$userData->subAppLinks()->pluck('sub_app_link_id')->contains($link->id)?'checked':''}}>
                           ...
                           <div class="card-footer d-flex justify-content-end">
                               <x-button wire:click.prevent="affecteSubLinks" type="button" class="btn btn-info"><i class="fas fa-sync"></i> Attribuer</x-button>
                           </div>
                       </div>
                  @endif
               </div>
