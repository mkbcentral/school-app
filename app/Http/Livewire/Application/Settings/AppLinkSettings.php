...
namespace App\Http\Livewire\Application\Settings;
...
class AppLinkSettings extends Component
{
    ...
    public function affecteSubLinks(){
        if ($this->linksSubSelected !=[]){
            ...
            $this->dispatchBrowserEvent('added',['message'=>'Menu bien affécté']);
        }else{
            $this->dispatchBrowserEvent('error',['message'=>'Aucun élément selectionné']);
        }
    }
