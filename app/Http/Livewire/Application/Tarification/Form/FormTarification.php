...
namespace App\Http\Livewire\Application\Tarification\Form;
...
class FormTarification extends Component
{
    ...
    public function store()
    {
        ...
        $this->emit('refreshListTarification');
        $this->dispatchBrowserEvent('added', ['message' => "Tarif bien créé !"]);
    }
    ...
    public function update()
    {
        ...
        $this->emit('refreshListTarification');
        $this->dispatchBrowserEvent('updated', ['message' => "Tarif bien modifié !"]);
